...
def init():
    ...
    parser.add_argument('--path_to_images', type=str, default='/mnt/video/hd_vila_sample',
                        help='directory to images')
    parser.add_argument('--path_to_save_csv', type=str, default="/mnt/video/sample_frame_list.txt",
                        help='directory to csv_folder')
    parser.add_argument('--experiment_dir_name', type=str, default='/mnt/video/exp/aesth/exp',
